        ...
        <div className="row">
          <div className="col-lg-5 mt-5">
            <div className="card mb-3">
              <img className="card-img img-fluid" src="/public/assets/img/1pro.jpg" alt="Card image cap" id="product-detail" />
            </div>
            <div className="row">
              {/*Start Controls*/}
                ...
                <div className="carousel-inner product-links-wap" role="listbox">
                  ...
                  <div className="carousel-item active">
                    <div className="row">
                      <div className="col-4">
                        <a href="#">
                          <img className="card-img img-fluid" src="/public/assets/img/1pro.jpg" alt="Product Image 1" />
                        </a>
                      </div>
                      <div className="col-4">
                        <a href="#">
                          <img className="card-img img-fluid" src="/public/assets/img/1pro.jpg" alt="Product Image 2" />
                        </a>
                      </div>
                      <div className="col-4">
                        <a href="#">
                          <img className="card-img img-fluid" src="/public/assets/img/1pro.jpg" alt="Product Image 3" />
                        </a>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="carousel-item">
                    <div className="row">
                      <div className="col-4">
                        <a href="#">
                          <img className="card-img img-fluid" src="/public/assets/img/1pro.jpg" alt="Product Image 4" />
                        </a>
                      </div>
                      <div className="col-4">
                        <a href="#">
                          <img className="card-img img-fluid" src="/public/assets/img/1pro.jpg" alt="Product Image 5" />
                        </a>
                      </div>
                      <div className="col-4">
                        <a href="#">
                          <img className="card-img img-fluid" src="/public/assets/img/1pro.jpg" alt="Product Image 6" />
                        </a>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="carousel-item">
                    <div className="row">
                      <div className="col-4">
                        <a href="#">
                          <img className="card-img img-fluid" src="/public/assets/img/1pro.jpg" alt="Product Image 7" />
                        </a>
                      </div>
                      <div className="col-4">
                        <a href="#">
                          <img className="card-img img-fluid" src="/public/assets/img/1pro.jpg" alt="Product Image 8" />
                        </a>
                      </div>
                      <div className="col-4">
                        <a href="#">
                          <img className="card-img img-fluid" src="/public/assets/img/1pro.jpg" alt="Product Image 9" />
                        </a>
                      </div>
                    </div>
                  </div>
          ...
          <div className="p-2 pb-3">
            <div className="product-wap card rounded-0">
              <div className="card rounded-0">
                <img className="card-img rounded-0 img-fluid" src="/public/assets/img/shop_10.jpg" />
