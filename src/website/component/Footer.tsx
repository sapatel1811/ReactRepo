      ...
      <div className="container">
        <div className="row">
          <div className="col-md-4 pt-5">
            <h2 className="h2 text-success border-bottom pb-3 border-light logo">Urban Shop</h2>
            <ul className="list-unstyled text-light footer-link-list">
              <li>
                <i className="fas fa-map-marker-alt fa-fw" />
                Maninager Ahmdabad 380026.
              </li>
              <li>
                <i className="fa fa-phone fa-fw" />
                <a className="text-decoration-none" href="tel:010-020-0340">7861817955</a>
              </li>
              <li>
                <i className="fa fa-envelope fa-fw" />
                <a className="text-decoration-none" href="mailto:info@company.com">sapna.verve@gmail.com</a>
              </li>
            </ul>
          </div>
          <div className="col-md-4 pt-5">
          ...
          <div className="row pt-2">
            <div className="col-12">
              <p className="text-left text-light">
                Copyright © 2026 Verve systems Pvt.Ltd
                | Designed by <a rel="sponsored" href="https://github.com/sapatel1811" target="_blank">Kishori</a>
              </p>
            </div>
          </div>
        </div>
